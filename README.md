...
### Tools & Languages:
![tools](https://skillicons.dev/icons?i=vscode,bash,github,git)
![skills](https://skillicons.dev/icons?i=html,bootstrap,css,js,python,mysql,flask,nodejs,react,mongodb)
